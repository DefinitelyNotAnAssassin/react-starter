    ...
    <BaseTemplate>
      ...
      <div className="bg-white p-4">
        ...
        <div className="flex justify-end mb-4">
          <button className="bg-blue-400 mx-1 px-3 py-1 rounded">
            Amendatory
          </button>
        ...
        <div className="flex h-[40vh] w-full mb-4 space-x-4">
          ...
          <div className="w-[15%] bg-gray-200 h-full p-2 rounded">
            ...
            <div className="space-y-2">
              <div>
                <label htmlFor="dateReceived" className="block text-sm">
                  Date Received
                </label>
                <input
                  type="date"
              ...
              <div>
                <label htmlFor="postedForProcurement" className="block text-sm">
                  Posted for Procurement
                </label>
                <input
                  type="date"
              ...
              <div>
                <label htmlFor="validated" className="block text-sm">
                  Validated
                </label>
                <input
                  type="date"
        ...
        <div className="flex h-[40vh] w-full space-x-4">
          ...
          <div className="w-[30%] bg-[#BAE2C5] h-full rounded p-4">
            ...
            <p>
              This section can be used for displaying additional details,
              summaries, or actions related to the goods and services.
            </p>
          </div>
        </div>
      </div>
